...
def djangofy(htmlfile):
    ...
    file_contents = insert_at_body_end(file_contents, '<script src="/static/js/custom-webflow.js"></script>')
    ...
    file_contents = insert_at_body_end(file_contents, '        var pageData = {{ page_data_json|safe }}')
    file_contents = insert_at_body_end(file_contents, '        var js = JSON.parse(pageData["data"]);')
    file_contents = insert_at_body_end(file_contents, '        mmWebflow(js);')
    file_contents = insert_at_body_end(file_contents, '    })')
    file_contents = insert_at_body_end(file_contents, '</script>')
