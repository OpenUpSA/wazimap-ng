...
from .. import models
from .choropleth_method_serializer import ChoroplethMethodSerializer
...
from .profile_indicator_serializer import ProfileIndicatorSerializer, ProfileIndicatorFullSerializer
