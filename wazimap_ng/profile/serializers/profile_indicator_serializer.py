...
class ProfileIndicatorSerializer(serializers.ModelSerializer):
    ...
    def get_category(self, obj: ProfileIndicator) -> str:
        return obj.subcategory.category.name

    def get_subcategory(self, obj: ProfileIndicator) -> str:
...
class FullProfileIndicatorSerializer(serializers.Serializer):
    ...
    def __init__(self, *args, geography: Geography, with_child_data: bool = False, **kwargs):
        self.geography = geography
        super(FullProfileIndicatorSerializer, self).__init__(*args, **kwargs)

    def get_indicator(self, obj: ProfileIndicator) -> List:
