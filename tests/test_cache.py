...
@patch("django.http.request", autospec=True)
@patch("wazimap_ng.profile.services.authentication.has_permission", autospec=True)
@patch("wazimap_ng.profile.models.Profile.objects", autospec=True)
...
@patch("django.http.request", autospec=True)
@patch("wazimap_ng.cache.datetime", autospec=True)
@patch("wazimap_ng.cache.check_has_permission", autospec=True)
...
@patch("django.http.request", autospec=True)
@patch("wazimap_ng.cache.last_modified_profile_updated", autospec=True)
...
@patch("django.http.request", autospec=True)
@patch("wazimap_ng.cache.last_modified", autospec=True)
...
@patch("django.http.request", autospec=True)
@patch("wazimap_ng.cache.last_modified_point_updated", autospec=True)
